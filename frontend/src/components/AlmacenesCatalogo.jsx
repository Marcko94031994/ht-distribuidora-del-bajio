...
export default function AlmacenesCatalogo({ data, sucursal, addAlmacen, updateAlmacen, reloadState }) {
  ...
  return (
    <div>
      {/* Modal Alta / Edición Almacén */}
      {showAlmacenModal && (
        <div className="modal">
          <div className="modal-content" style={{ maxWidth: '500px', width: '90%' }}>
            <div className="card-h">
              <h3>{editingAlmacen ? 'Editar Almacén' : 'Alta de Almacén (Ligado a sucursal)'}</h3>
      ...
      {/* Modal Alta Ubicación */}
      {showUbicacionModal && (
        <div className="modal">
          <div className="modal-content" style={{ maxWidth: '500px', width: '90%' }}>
            <div className="card-h">
              <h3>Alta de Ubicación / Rack</h3>
            ...
            <div className="card-b">
              <form onSubmit={handleAddLocation} className="form-grid">
                ...
                <button type="submit" className="btn primary full">Agregar Ubicación</button>
              </form>
            </div>
          </div>
        </div>
